...
module ActiveRecord
  ...
  def self.allow_deprecated_singular_associations_name=(value); end
  ...
  def self.commit_transaction_on_non_local_return=(value); end
...
class ActiveRecord::Encryption::Encryptor
  ...
  def forced_encoding_for_deterministic_encryption; end
  def initialize(compress: nil); end
...
module ActiveRecord::ConnectionAdapters::DatabaseStatements
  ...
  def internal_exec_query(sql, name = nil, binds = nil, prepare: nil, async: nil, allow_retry: nil); end
...
class ActiveRecord::Migration::Compatibility::V7_1 < ActiveRecord::Migration::Current
end
